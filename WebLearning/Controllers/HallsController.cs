...
namespace MovieManagementMVC.Controllers
{
    public class HallsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HallId,HallName,HallDescription")] Halls halls)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HallId,HallName,HallDescription")] Halls halls)
        {
            if (id != halls.HallId)
            {
                return NotFound();
